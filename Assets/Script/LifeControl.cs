...
public class LifeControl: MonoBehaviour {
    ...
    {
	    GameObject childObject = Instantiate(life, lifePanel.transform.position, lifePanel.transform.rotation);
	    childObject.transform.SetParent(lifePanel.transform, false);
	    childs.Add(childObject.transform);
 		// childObject.transform.parent = lifePanel.transform;
    }
}
